...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/usr/local/rvm/rubies/ruby-2.6.6")
  ...
  CONFIG["configure_args"] = " '--prefix=/usr/local/rvm/rubies/ruby-2.6.6' '--with-openssl-dir=/usr/local/rvm/usr' '--disable-install-doc' '--enable-shared'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/usr/local/rvm/rubies/ruby-2.6.6"
